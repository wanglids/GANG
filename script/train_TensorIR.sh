...
# list="armadillo hotdog ficus" #lego armadillo hotdog ficus   armadillo hotdog ficus
# lego 
# list="lego" pip i
list="hotdog lego"  
# wo_sdf wo_IIF wo_local wo_SG wo_normal 
# wo_meta
for i in $list
do
    modellists="new"
    ...
    do
        ...
        source_path=/home/dqli/program/data/TensoIRSynthetic/${i}
        model_path=outputs/TensoIRSynthetic/${i}_${modename}
