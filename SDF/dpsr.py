...
class DPSR(nn.Module):
    def __init__(self, res, sig=10, scale=True, shift=True):
        ...
        G = spec_gaussian_filter(res=res, sig=sig).float().cuda()
